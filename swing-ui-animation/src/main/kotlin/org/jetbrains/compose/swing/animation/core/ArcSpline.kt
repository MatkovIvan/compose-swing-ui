...
import org.jetbrains.compose.swing.animation.core.internal.binarySearch
...
internal class ArcSpline(
    ...
    class Arc
        internal constructor(
            ...
            inline fun calcX(): Float = ellipseCenterX + ellipseA * tmpSinAngle

            inline fun calcY(): Float = ellipseCenterY + ellipseB * tmpCosAngle
...
// Flattened from the Kotlin Multiplatform expect/actual pair (ArcSpline.jvmAndAndroid.kt) to the JVM
// actual. Sourced from compose-multiplatform-core.
internal inline fun binarySearch(
    array: FloatArray,
    position: Float,
): Int = array.binarySearch(position)
